...
namespace ProyectoTest.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult ListarProducto()
        {
            try
            {
                List<Producto> listaProductos = ProductoLogica.Instancia.Listar();

                var data = listaProductos.Select(p => new
                {
                    p.IdProducto,
                    p.Nombre,
                    p.Descripcion,
                    ...
                    p.Precio,
                    p.Stock,
                    Activo = p.Activo ? "Activo" : "No Activo"
                });
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { error = "Error al listar productos" }, JsonRequestBehavior.AllowGet);
            }
        }
